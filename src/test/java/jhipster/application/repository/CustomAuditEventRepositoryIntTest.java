...
import jhipster.application.config.audit.AuditEventConverter;
import jhipster.application.domain.PersistentAuditEvent;
...
import static jhipster.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
