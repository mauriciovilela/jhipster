...
import jhipster.application.config.Constants;
import jhipster.application.JhipsterApp;
import jhipster.application.domain.Authority;
import jhipster.application.domain.User;
import jhipster.application.repository.AuthorityRepository;
import jhipster.application.repository.UserRepository;
import jhipster.application.security.AuthoritiesConstants;
import jhipster.application.service.MailService;
import jhipster.application.service.dto.UserDTO;
import jhipster.application.web.rest.errors.ExceptionTranslator;
import jhipster.application.web.rest.vm.KeyAndPasswordVM;
import jhipster.application.web.rest.vm.ManagedUserVM;
import jhipster.application.service.UserService;
